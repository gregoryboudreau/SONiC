...
|:---:|:-----------:|:------------------:|-----------------------------------|
| 0.1 | 07/24/2025  |   Cisco Team       | Initial version                   |

## Scope

This document provides a high-level design for the LLDP Custom TLV feature in SONiC. The feature enables users to configure custom TLVs for advertisement, or allows other SONiC features to use custom TLVs to communicate with neighboring devices.
